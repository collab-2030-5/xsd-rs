...
impl OadrRegisterReportType {
        ...
        W: std::io::Write,
    {
        ...
        if let Some(elem) = &self.ei_report_request_id {
            xsd_util::write_simple_element(writer, "ei:reportRequestID", elem.as_str())?;
        }
        Ok(())
    }
...
impl xsd_api::WriteXml for OadrRegisterReportType {
    fn write<W>(
        &self,
...
impl xsd_api::ReadXml for OadrRegisterReportType {
