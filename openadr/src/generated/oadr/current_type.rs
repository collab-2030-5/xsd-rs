...
impl CurrentType {
        ...
        W: std::io::Write,
    {
        ...
        let start = if write_type {
            start.attr("xsi:type", "oadr:CurrentType")
        } else {
            start
        };
        writer.write(start)?;
...
impl xsd_api::WriteXml for CurrentType {
    fn write<W>(
        &self,
...
impl CurrentType {
        ...
        R: std::io::Read,
    {
        ...
        CurrentType::read(reader, &attr, "oadr:CurrentType")
    }
}

impl xsd_api::ReadXml for CurrentType {
