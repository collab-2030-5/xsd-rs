...
impl OadrCanceledReportType {
        ...
        W: std::io::Write,
    {
        ...
        let start = if write_type {
            start.attr("xsi:type", "oadr:oadrCanceledReportType")
        } else {
            start
        };
        writer.write(start)?;
...
impl xsd_api::WriteXml for OadrCanceledReportType {
    fn write<W>(
        &self,
...
impl OadrCanceledReportType {
        ...
        R: std::io::Read,
    {
        ...
        OadrCanceledReportType::read(reader, &attr, "oadr:oadrCanceledReportType")
    }
}

impl xsd_api::ReadXml for OadrCanceledReportType {
