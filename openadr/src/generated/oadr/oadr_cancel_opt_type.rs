...
impl xsd_api::WriteXml for OadrCancelOptType {
    fn write<W>(
        &self,
        ...
        W: std::io::Write,
    {
        ...
        self.write_with_name(&mut writer, "oadr:oadrCancelOptType", true, false)?;
        Ok(())
    }
}
...
impl xsd_api::ReadXml for OadrCancelOptType {
