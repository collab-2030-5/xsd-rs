...
impl OadrCreatedReportType {
        ...
        W: std::io::Write,
    {
        ...
        let start = if write_type {
            start.attr("xsi:type", "oadr:oadrCreatedReportType")
        } else {
            start
        };
        writer.write(start)?;
...
impl xsd_api::WriteXml for OadrCreatedReportType {
    fn write<W>(
        &self,
        ...
        W: std::io::Write,
    {
        ...
        self.write_with_name(&mut writer, "oadr:oadrCreatedReportType", true, false)?;
        Ok(())
    }
}
...
impl OadrCreatedReportType {
    ...
    where
        R: std::io::Read,
    {
        let attr = xsd_util::read_start_tag(reader, "oadrCreatedReportType")?;
        OadrCreatedReportType::read(reader, &attr, "oadr:oadrCreatedReportType")
    }
}

impl xsd_api::ReadXml for OadrCreatedReportType {
