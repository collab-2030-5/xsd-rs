...
impl xsd_api::WriteXml for OadrReportPayloadType {
    fn write<W>(
        &self,
        ...
        W: std::io::Write,
    {
        ...
        self.write_with_name(&mut writer, "oadr:oadrReportPayloadType", true, false)?;
        Ok(())
    }
}
...
impl xsd_api::ReadXml for OadrReportPayloadType {
