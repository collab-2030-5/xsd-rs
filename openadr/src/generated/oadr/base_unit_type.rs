...
impl BaseUnitType {
        ...
        W: std::io::Write,
    {
        ...
        let start = if write_type {
            start.attr("xsi:type", "oadr:BaseUnitType")
        } else {
            start
        };
        writer.write(start)?;
...
impl xsd_api::WriteXml for BaseUnitType {
    fn write<W>(
        &self,
...
impl BaseUnitType {
        ...
        R: std::io::Read,
    {
        ...
        BaseUnitType::read(reader, &attr, "oadr:BaseUnitType")
    }
}

impl xsd_api::ReadXml for BaseUnitType {
