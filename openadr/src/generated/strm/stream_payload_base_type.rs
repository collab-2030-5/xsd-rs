...
pub struct StreamPayloadBaseType {}
...
impl xsd_api::WriteXml for StreamPayloadBaseType {
    fn write<W>(
        &self,
        ...
        W: std::io::Write,
    {
        ...
        self.write_with_name(&mut writer, "strm:StreamPayloadBaseType", true, false)?;
        Ok(())
    }
}
...
impl xsd_api::ReadXml for StreamPayloadBaseType {
        ...
        R: std::io::Read,
    {
        ...
        match StreamPayloadBaseType::read_top_level(&mut reader) {
            Ok(x) => Ok(x),
            Err(err) => {
