...
pub struct Intervals {
    pub ei_interval: Vec<crate::oadr20a::ei::IntervalType>,
}
...
impl crate::xsd_util::WriteXml for Intervals {
    fn write<W>(
        &self,
...
impl Intervals {
        ...
        loop {
            match reader.next()? {
                ...
                xml::reader::XmlEvent::StartElement {
                    ...
                    "interval" => ei_interval.push(crate::oadr20a::ei::IntervalType::read(
                        reader,
                        &attributes,
                        "interval",
                    )?),
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "intervals")?;
        Intervals::read(reader, &attr, "intervals")
    }
}

impl crate::xsd_util::ReadXml for Intervals {
