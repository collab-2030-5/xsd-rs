...
pub struct CurrentValueType {
    pub current_value_type_choice: crate::oadr20a::ei::CurrentValueTypeChoice,
}
...
impl crate::xsd_util::WriteXml for CurrentValueType {
    fn write<W>(
        &self,
...
impl CurrentValueType {
        ...
        R: std::io::Read,
    {
        ...
        let mut current_value_type_choice: crate::xsd_util::SetOnce<
            crate::oadr20a::ei::CurrentValueTypeChoice,
        > = Default::default();
                ...
                xml::reader::XmlEvent::StartElement {
                    ...
                    "payloadFloat" => current_value_type_choice.set(
                        crate::oadr20a::ei::CurrentValueTypeChoice::EiPayloadFloat(
                            crate::oadr20a::ei::PayloadFloat::read(
                                reader,
                                &attributes,
                                "payloadFloat",
                            )?,
        ...
        Ok(CurrentValueType {
            current_value_type_choice: current_value_type_choice.require()?,
        })
    }
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "currentValue")?;
        CurrentValueType::read(reader, &attr, "currentValue")
    }
}

impl crate::xsd_util::ReadXml for CurrentValueType {
        ...
        R: std::io::Read,
    {
        ...
        match CurrentValueType::read_top_level(&mut reader) {
            Ok(x) => Ok(x),
            Err(err) => {
