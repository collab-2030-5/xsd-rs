...
pub struct EiEventType {
    ...
    pub ei_ei_event_signals: crate::oadr20a::ei::EiEventSignalsType,
    pub ei_ei_target: crate::oadr20a::ei::EiTargetType,
}
...
impl EiEventType {
        ...
        R: std::io::Read,
    {
        ...
        let mut ei_event_descriptor: xsd_util::SetOnce<crate::oadr20a::ei::EventDescriptorType> =
            Default::default();
        let mut ei_ei_active_period: xsd_util::SetOnce<crate::oadr20a::ei::EiActivePeriodType> =
            Default::default();
        let mut ei_ei_event_signals: xsd_util::SetOnce<crate::oadr20a::ei::EiEventSignalsType> =
            Default::default();
        let mut ei_ei_target: xsd_util::SetOnce<crate::oadr20a::ei::EiTargetType> =
            Default::default();
        ...
        loop {
            match reader.next()? {
                ...
                xml::reader::XmlEvent::StartElement {
                    ...
                    "eventDescriptor" => {
                        ei_event_descriptor.set(crate::oadr20a::ei::EventDescriptorType::read(
                            reader,
                            &attributes,
                            "eventDescriptor",
                        )?)?
                    ...
                    "eiActivePeriod" => {
                        ei_ei_active_period.set(crate::oadr20a::ei::EiActivePeriodType::read(
                            reader,
                            &attributes,
                            "eiActivePeriod",
                        )?)?
                    ...
                    "eiEventSignals" => {
                        ei_ei_event_signals.set(crate::oadr20a::ei::EiEventSignalsType::read(
                            reader,
                            &attributes,
                            "eiEventSignals",
                        )?)?
                    }
                    "eiTarget" => ei_ei_target.set(crate::oadr20a::ei::EiTargetType::read(
                        reader,
                        &attributes,
                        "eiTarget",
                    )?)?,
    ...
    where
        R: std::io::Read,
    {
        let attr = xsd_util::read_start_tag(reader, "eiEvent")?;
