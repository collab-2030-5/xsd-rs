...
impl crate::xsd_util::WriteXml for EiMarketContext {
    fn write<W>(
        &self,
...
impl EiMarketContext {
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "eiMarketContext")?;
        EiMarketContext::read(reader, &attr, "eiMarketContext")
    }
}

impl crate::xsd_util::ReadXml for EiMarketContext {
