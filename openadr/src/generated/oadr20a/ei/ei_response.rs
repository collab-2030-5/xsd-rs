...
impl EiResponse {
        ...
        W: std::io::Write,
    {
        ...
        let start = if write_type {
            start.attr("xsi:type", "eiResponse")
        } else {
            start
        };
        writer.write(start)?;
...
impl crate::xsd_util::WriteXml for EiResponse {
    fn write<W>(
        &self,
...
impl EiResponse {
        ...
        R: std::io::Read,
    {
        ...
        EiResponse::read(reader, &attr, "eiResponse")
    }
}

impl crate::xsd_util::ReadXml for EiResponse {
        ...
        R: std::io::Read,
    {
        ...
        match EiResponse::read_top_level(&mut reader) {
            Ok(x) => Ok(x),
            Err(err) => {
