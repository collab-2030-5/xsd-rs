...
pub struct EiActivePeriodType {
    pub xcal_properties: crate::oadr20a::xcal::Properties,
    pub xcal_components: crate::oadr20a::xcal::Components,
}
...
impl crate::xsd_util::WriteXml for EiActivePeriodType {
    fn write<W>(
        &self,
...
impl EiActivePeriodType {
        ...
        R: std::io::Read,
    {
        ...
        let mut xcal_properties: crate::xsd_util::SetOnce<crate::oadr20a::xcal::Properties> =
            Default::default();
        let mut xcal_components: crate::xsd_util::SetOnce<crate::oadr20a::xcal::Components> =
            Default::default();
        ...
        loop {
            match reader.next()? {
                ...
                xml::reader::XmlEvent::StartElement {
                    ...
                    "properties" => xcal_properties.set(crate::oadr20a::xcal::Properties::read(
                        reader,
                        &attributes,
                        "properties",
                    )?)?,
                    "components" => xcal_components.set(crate::oadr20a::xcal::Components::read(
                        reader,
                        &attributes,
                        "components",
                    )?)?,
        ...
        Ok(EiActivePeriodType {
            xcal_properties: xcal_properties.require()?,
            xcal_components: xcal_components.require()?,
        })
    }
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "eiActivePeriod")?;
        EiActivePeriodType::read(reader, &attr, "eiActivePeriod")
    }
}

impl crate::xsd_util::ReadXml for EiActivePeriodType {
        ...
        R: std::io::Read,
    {
        ...
        match EiActivePeriodType::read_top_level(&mut reader) {
            Ok(x) => Ok(x),
            Err(err) => {
