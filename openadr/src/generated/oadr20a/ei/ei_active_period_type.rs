...
impl xsd_api::WriteXml for EiActivePeriodType {
    fn write<W>(
        &self,
...
impl EiActivePeriodType {
        ...
        R: std::io::Read,
    {
        ...
        let mut xcal_properties: xsd_util::SetOnce<crate::oadr20a::xcal::Properties> =
            Default::default();
...
impl xsd_api::ReadXml for EiActivePeriodType {
