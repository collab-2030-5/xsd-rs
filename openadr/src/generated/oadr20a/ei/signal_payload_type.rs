...
pub struct SignalPayloadType {
    pub ei_payload_float: crate::oadr20a::ei::PayloadFloat,
}
...
impl SignalPayloadType {
    ...
    where
        W: std::io::Write,
    {
        self.ei_payload_float
            .write_with_name(writer, "ei:payloadFloat", false, false)?;
        Ok(())
    }
...
impl crate::xsd_util::WriteXml for SignalPayloadType {
    fn write<W>(
        &self,
...
impl SignalPayloadType {
        ...
        R: std::io::Read,
    {
        ...
        let mut ei_payload_float: crate::xsd_util::SetOnce<crate::oadr20a::ei::PayloadFloat> =
            Default::default();
        ...
        loop {
            match reader.next()? {
                ...
                xml::reader::XmlEvent::StartElement {
                    ...
                    "payloadFloat" => {
                        ei_payload_float.set(crate::oadr20a::ei::PayloadFloat::read(
                            reader,
                            &attributes,
                            "payloadFloat",
                        )?)?
        ...
        Ok(SignalPayloadType {
            ei_payload_float: ei_payload_float.require()?,
        })
    }
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "signalPayload")?;
        SignalPayloadType::read(reader, &attr, "signalPayload")
    }
}

impl crate::xsd_util::ReadXml for SignalPayloadType {
        ...
        R: std::io::Read,
    {
        ...
        match SignalPayloadType::read_top_level(&mut reader) {
            Ok(x) => Ok(x),
            Err(err) => {
