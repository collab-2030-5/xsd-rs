...
pub struct Properties {
    pub xcal_dtstart: crate::oadr20a::xcal::Dtstart,
    pub xcal_duration: crate::oadr20a::xcal::DurationPropType,
    pub tolerance: Option<crate::oadr20a::xcal::Tolerance>,
    pub ei_x_ei_notification: crate::oadr20a::xcal::DurationPropType,
    pub ei_x_ei_ramp_up: Option<crate::oadr20a::xcal::DurationPropType>,
    pub ei_x_ei_recovery: Option<crate::oadr20a::xcal::DurationPropType>,
}
...
impl Properties {
        ...
        W: std::io::Write,
    {
        ...
        self.ei_x_ei_notification
            .write_with_name(writer, "ei:x-eiNotification", false, false)?;
...
impl Properties {
        ...
        R: std::io::Read,
    {
        ...
        loop {
            match reader.next()? {
                ...
                xml::reader::XmlEvent::StartElement {
                    ...
                    "tolerance" => tolerance.set(crate::oadr20a::xcal::Tolerance::read(
                        reader,
                        &attributes,
                        "tolerance",
                    )?)?,
                    "x-eiNotification" => {
                        ei_x_ei_notification.set(crate::oadr20a::xcal::DurationPropType::read(
                            reader,
                            &attributes,
                            "x-eiNotification",
                        )?)?
                    ...
                    "x-eiRampUp" => {
                        ei_x_ei_ramp_up.set(crate::oadr20a::xcal::DurationPropType::read(
                            reader,
                            &attributes,
                            "x-eiRampUp",
                        )?)?
                    ...
                    "x-eiRecovery" => {
                        ei_x_ei_recovery.set(crate::oadr20a::xcal::DurationPropType::read(
                            reader,
                            &attributes,
                            "x-eiRecovery",
                        )?)?
        ...
        Ok(Properties {
            ...
            ei_x_ei_notification: ei_x_ei_notification.require()?,
