...
impl crate::xsd_util::WriteXml for Components {
    fn write<W>(
        &self,
        ...
        W: std::io::Write,
    {
        ...
        self.write_with_name(&mut writer, "xcal:components", true, false)?;
        Ok(())
    }
}
...
impl Components {
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "components")?;
        Components::read(reader, &attr, "components")
    }
}

impl crate::xsd_util::ReadXml for Components {
        ...
        R: std::io::Read,
    {
        ...
        match Components::read_top_level(&mut reader) {
            Ok(x) => Ok(x),
            Err(err) => {
