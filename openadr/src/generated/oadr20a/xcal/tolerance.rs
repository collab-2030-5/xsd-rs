...
pub struct Tolerance {
    pub tolerate: crate::oadr20a::xcal::Tolerate,
}
...
impl crate::xsd_util::WriteXml for Tolerance {
    fn write<W>(
        &self,
...
impl Tolerance {
        ...
        R: std::io::Read,
    {
        ...
        let mut tolerate: crate::xsd_util::SetOnce<crate::oadr20a::xcal::Tolerate> =
            Default::default();
        ...
        loop {
            match reader.next()? {
                ...
                xml::reader::XmlEvent::StartElement {
                    ...
                    "tolerate" => tolerate.set(crate::oadr20a::xcal::Tolerate::read(
                        reader,
                        &attributes,
                        "tolerate",
                    )?)?,
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "tolerance")?;
        Tolerance::read(reader, &attr, "tolerance")
    }
}

impl crate::xsd_util::ReadXml for Tolerance {
