...
pub struct OadrEvent {
    ...
    pub oadr_response_required: crate::oadr20a::oadr::ResponseRequiredType,
}
...
impl crate::xsd_util::WriteXml for OadrEvent {
    fn write<W>(
        &self,
...
impl OadrEvent {
        ...
        R: std::io::Read,
    {
        ...
        let mut ei_ei_event: crate::xsd_util::SetOnce<crate::oadr20a::ei::EiEventType> =
            Default::default();
        let mut oadr_response_required: crate::xsd_util::SetOnce<
            crate::oadr20a::oadr::ResponseRequiredType,
        > = Default::default();
        ...
        loop {
            match reader.next()? {
                ...
                xml::reader::XmlEvent::StartElement {
                    ...
                    "eiEvent" => ei_ei_event.set(crate::oadr20a::ei::EiEventType::read(
                        reader,
                        &attributes,
                        "eiEvent",
                    )?)?,
                    "oadrResponseRequired" => oadr_response_required.set(
                        crate::xsd_util::read_string_enum(reader, "oadrResponseRequired")?,
                    )?,
                    name => {
        ...
        Ok(OadrEvent {
            ...
            oadr_response_required: oadr_response_required.require()?,
        })
    }
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "oadrEvent")?;
        OadrEvent::read(reader, &attr, "oadrEvent")
    }
}

impl crate::xsd_util::ReadXml for OadrEvent {
