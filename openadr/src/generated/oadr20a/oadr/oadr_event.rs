...
impl OadrEvent {
        ...
        R: std::io::Read,
    {
        ...
        let mut ei_ei_event: xsd_util::SetOnce<crate::oadr20a::ei::EiEventType> =
            Default::default();
        let mut oadr_response_required: xsd_util::SetOnce<
        ...
        loop {
            match reader.next()? {
                ...
                xml::reader::XmlEvent::StartElement {
                    ...
                    "oadrResponseRequired" => oadr_response_required
