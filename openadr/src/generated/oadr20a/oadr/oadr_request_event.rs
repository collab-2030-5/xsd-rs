...
pub struct OadrRequestEvent {
    pub pyld_ei_request_event: crate::oadr20a::pyld::EiRequestEvent,
}

impl OadrRequestEvent {
    fn write_elem<W>(
        &self,
        ...
        W: std::io::Write,
    {
        ...
        let start = if write_type {
            start.attr("xsi:type", "oadrRequestEvent")
        } else {
            start
        };
        writer.write(start)?;
...
impl crate::xsd_util::WriteXml for OadrRequestEvent {
    fn write<W>(
        &self,
...
impl OadrRequestEvent {
        ...
        R: std::io::Read,
    {
        ...
        let mut pyld_ei_request_event: crate::xsd_util::SetOnce<
            crate::oadr20a::pyld::EiRequestEvent,
        > = Default::default();
        ...
        loop {
            match reader.next()? {
                ...
                xml::reader::XmlEvent::StartElement {
                    ...
                    "eiRequestEvent" => {
                        pyld_ei_request_event.set(crate::oadr20a::pyld::EiRequestEvent::read(
                            reader,
                            &attributes,
                            "eiRequestEvent",
                        )?)?
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "oadrRequestEvent")?;
        OadrRequestEvent::read(reader, &attr, "oadrRequestEvent")
    }
}

impl crate::xsd_util::ReadXml for OadrRequestEvent {
        ...
        R: std::io::Read,
    {
        ...
        match OadrRequestEvent::read_top_level(&mut reader) {
            Ok(x) => Ok(x),
            Err(err) => {
