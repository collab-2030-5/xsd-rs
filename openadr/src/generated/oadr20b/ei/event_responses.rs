...
pub struct EventResponses {
    pub event_response: Vec<crate::oadr20b::ei::EventResponse>,
}
...
impl crate::xsd_util::WriteXml for EventResponses {
    fn write<W>(
        &self,
        ...
        W: std::io::Write,
    {
        ...
        self.write_with_name(&mut writer, "ei:eventResponses", true, false)?;
        Ok(())
    }
}
...
impl EventResponses {
        ...
        R: std::io::Read,
    {
        ...
        let mut event_response: Vec<crate::oadr20b::ei::EventResponse> = Default::default();
        ...
        loop {
            match reader.next()? {
                ...
                xml::reader::XmlEvent::StartElement {
                    ...
                    "eventResponse" => {
                        event_response.push(crate::oadr20b::ei::EventResponse::read(
                            reader,
                            &attributes,
                            "eventResponse",
                        )?)
        ...
        Ok(EventResponses { event_response })
    }
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "eventResponses")?;
        EventResponses::read(reader, &attr, "eventResponses")
    }
}

impl crate::xsd_util::ReadXml for EventResponses {
        ...
        R: std::io::Read,
    {
        ...
        match EventResponses::read_top_level(&mut reader) {
            Ok(x) => Ok(x),
            Err(err) => {
