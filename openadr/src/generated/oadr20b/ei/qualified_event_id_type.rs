...
impl crate::xsd_util::WriteXml for QualifiedEventIdType {
    fn write<W>(
        &self,
...
impl QualifiedEventIdType {
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "qualifiedEventID")?;
        QualifiedEventIdType::read(reader, &attr, "qualifiedEventID")
    }
}

impl crate::xsd_util::ReadXml for QualifiedEventIdType {
