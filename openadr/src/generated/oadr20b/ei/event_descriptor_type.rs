...
impl EventDescriptorType {
        ...
        W: std::io::Write,
    {
        ...
        if let Some(elem) = &self.modification_reason {
            crate::xsd_util::write_simple_element(writer, "ei:modificationReason", elem.as_str())?;
        }
...
impl EventDescriptorType {
        ...
        R: std::io::Read,
    {
        ...
        let mut modification_date_time: crate::xsd_util::SetOnce<String> = Default::default();
        let mut modification_reason: crate::xsd_util::SetOnce<String> = Default::default();
        let mut priority: crate::xsd_util::SetOnce<u32> = Default::default();
        let mut ei_market_context: crate::xsd_util::SetOnce<crate::oadr20b::ei::EiMarketContext> =
            Default::default();
        let mut ei_created_date_time: crate::xsd_util::SetOnce<String> = Default::default();
        let mut ei_event_status: crate::xsd_util::SetOnce<
            crate::oadr20b::ei::EventStatusEnumeratedType,
        > = Default::default();
        ...
        loop {
            match reader.next()? {
                ...
                xml::reader::XmlEvent::StartElement {
                    ...
                    "modificationDateTime" => modification_date_time.set(
                        crate::xsd_util::read_string(reader, "modificationDateTime")?,
                    )?,
                    "modificationReason" => modification_reason
                        .set(crate::xsd_util::read_string(reader, "modificationReason")?)?,
                    "priority" => {
