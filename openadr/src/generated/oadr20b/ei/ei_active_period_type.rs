...
impl EiActivePeriodType {
        ...
        R: std::io::Read,
    {
        ...
        let mut xcal_properties: crate::xsd_util::SetOnce<crate::oadr20b::xcal::Properties> =
            Default::default();
        let mut xcal_components: crate::xsd_util::SetOnce<crate::oadr20b::xcal::Components> =
            Default::default();
