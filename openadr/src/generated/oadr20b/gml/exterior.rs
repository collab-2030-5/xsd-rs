...
impl crate::xsd_util::WriteXml for Exterior {
    fn write<W>(
        &self,
...
impl Exterior {
        ...
        R: std::io::Read,
    {
        ...
        let mut linear_ring: crate::xsd_util::SetOnce<crate::oadr20b::gml::LinearRing> =
            Default::default();
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "exterior")?;
        Exterior::read(reader, &attr, "exterior")
    }
}

impl crate::xsd_util::ReadXml for Exterior {
