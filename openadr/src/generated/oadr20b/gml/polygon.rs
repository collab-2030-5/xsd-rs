...
pub struct Polygon {
    pub exterior: crate::oadr20b::gml::Exterior,
...
impl crate::xsd_util::WriteXml for Polygon {
    fn write<W>(
        &self,
...
impl Polygon {
        ...
        R: std::io::Read,
    {
        ...
        let mut exterior: crate::xsd_util::SetOnce<crate::oadr20b::gml::Exterior> =
            Default::default();
        let mut gml_id: crate::xsd_util::SetOnce<String> = Default::default();
        ...
        loop {
            match reader.next()? {
                ...
                xml::reader::XmlEvent::StartElement {
                    ...
                    "exterior" => exterior.set(crate::oadr20b::gml::Exterior::read(
                        reader,
                        &attributes,
                        "exterior",
                    )?)?,
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "Polygon")?;
        Polygon::read(reader, &attr, "Polygon")
    }
}

impl crate::xsd_util::ReadXml for Polygon {
