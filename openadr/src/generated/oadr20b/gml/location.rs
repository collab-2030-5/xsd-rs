...
impl crate::xsd_util::WriteXml for Location {
    fn write<W>(
        &self,
...
impl Location {
        ...
        R: std::io::Read,
    {
        ...
        let mut polygon: crate::xsd_util::SetOnce<crate::oadr20b::gml::Polygon> =
            Default::default();
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "location")?;
        Location::read(reader, &attr, "location")
    }
}

impl crate::xsd_util::ReadXml for Location {
