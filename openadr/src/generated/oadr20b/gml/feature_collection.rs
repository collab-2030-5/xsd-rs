...
impl crate::xsd_util::WriteXml for FeatureCollection {
    fn write<W>(
        &self,
...
impl FeatureCollection {
        ...
        R: std::io::Read,
    {
        ...
        let mut location: crate::xsd_util::SetOnce<crate::oadr20b::gml::Location> =
            Default::default();
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "FeatureCollection")?;
        FeatureCollection::read(reader, &attr, "FeatureCollection")
    }
}

impl crate::xsd_util::ReadXml for FeatureCollection {
