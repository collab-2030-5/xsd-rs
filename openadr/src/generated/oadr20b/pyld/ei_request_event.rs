...
impl EiRequestEvent {
        ...
        W: std::io::Write,
    {
        ...
        if let Some(elem) = &self.pyld_reply_limit {
            crate::xsd_util::write_element_using_to_string(writer, "pyld:replyLimit", elem)?;
        }
        Ok(())
    }
...
impl crate::xsd_util::WriteXml for EiRequestEvent {
    fn write<W>(
        &self,
...
impl EiRequestEvent {
        ...
        R: std::io::Read,
    {
        ...
        let mut pyld_reply_limit: crate::xsd_util::SetOnce<u32> = Default::default();
            ...
            match reader.next()? {
                ...
                xml::reader::XmlEvent::StartElement { name, .. } => {
                    match name.local_name.as_str() {
                        ...
                        "replyLimit" => pyld_reply_limit.set(
                            crate::xsd_util::read_type_from_string(reader, "replyLimit")?,
                        )?,
                        name => {
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "eiRequestEvent")?;
        EiRequestEvent::read(reader, &attr, "eiRequestEvent")
    }
}

impl crate::xsd_util::ReadXml for EiRequestEvent {
