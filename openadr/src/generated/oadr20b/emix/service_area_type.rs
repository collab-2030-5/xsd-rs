...
impl crate::xsd_util::WriteXml for ServiceAreaType {
    fn write<W>(
        &self,
...
impl ServiceAreaType {
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "serviceArea")?;
        ServiceAreaType::read(reader, &attr, "serviceArea")
    }
}

impl crate::xsd_util::ReadXml for ServiceAreaType {
