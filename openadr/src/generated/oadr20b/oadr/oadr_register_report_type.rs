...
impl OadrRegisterReportType {
        ...
        W: std::io::Write,
    {
        ...
        if let Some(elem) = &self.ei_report_request_id {
            crate::xsd_util::write_simple_element(writer, "ei:reportRequestID", elem.as_str())?;
        }
        Ok(())
    }
...
impl crate::xsd_util::WriteXml for OadrRegisterReportType {
    fn write<W>(
        &self,
...
impl OadrRegisterReportType {
        ...
        R: std::io::Read,
    {
        ...
        Ok(OadrRegisterReportType {
            pyld_request_id: pyld_request_id.require()?,
            oadr_oadr_report,
            ei_ven_id: ei_ven_id.get(),
            ei_report_request_id: ei_report_request_id.get(),
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "oadrRegisterReport")?;
        OadrRegisterReportType::read(reader, &attr, "oadrRegisterReport")
    }
}

impl crate::xsd_util::ReadXml for OadrRegisterReportType {
        ...
        R: std::io::Read,
    {
        ...
        match OadrRegisterReportType::read_top_level(&mut reader) {
            Ok(x) => Ok(x),
            Err(err) => {
