...
pub struct OadrServiceSpecificInfo {
    pub oadr_service: Vec<crate::oadr20b::oadr::OadrService>,
}
...
impl crate::xsd_util::WriteXml for OadrServiceSpecificInfo {
    fn write<W>(
        &self,
        ...
        W: std::io::Write,
    {
        ...
        self.write_with_name(&mut writer, "oadr:oadrServiceSpecificInfo", true, false)?;
        Ok(())
    }
}
...
impl OadrServiceSpecificInfo {
        ...
        R: std::io::Read,
    {
        ...
        let mut oadr_service: Vec<crate::oadr20b::oadr::OadrService> = Default::default();
        ...
        loop {
            match reader.next()? {
                ...
                xml::reader::XmlEvent::StartElement {
                    ...
                    "oadrService" => oadr_service.push(crate::oadr20b::oadr::OadrService::read(
                        reader,
                        &attributes,
                        "oadrService",
                    )?),
        ...
        Ok(OadrServiceSpecificInfo { oadr_service })
    }
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "oadrServiceSpecificInfo")?;
        OadrServiceSpecificInfo::read(reader, &attr, "oadrServiceSpecificInfo")
    }
}

impl crate::xsd_util::ReadXml for OadrServiceSpecificInfo {
        ...
        R: std::io::Read,
    {
        ...
        match OadrServiceSpecificInfo::read_top_level(&mut reader) {
            Ok(x) => Ok(x),
            Err(err) => {
