...
impl crate::xsd_util::WriteXml for OadrResponseType {
    fn write<W>(
        &self,
...
impl crate::xsd_util::ReadXml for OadrResponseType {
        ...
        R: std::io::Read,
    {
        ...
        match OadrResponseType::read_top_level(&mut reader) {
            Ok(x) => Ok(x),
            Err(err) => {
