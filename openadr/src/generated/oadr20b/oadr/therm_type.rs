...
impl crate::xsd_util::WriteXml for ThermType {
    fn write<W>(
        &self,
...
impl ThermType {
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "Therm")?;
        ThermType::read(reader, &attr, "Therm")
    }
}

impl crate::xsd_util::ReadXml for ThermType {
        ...
        R: std::io::Read,
    {
        ...
        match ThermType::read_top_level(&mut reader) {
            Ok(x) => Ok(x),
            Err(err) => {
