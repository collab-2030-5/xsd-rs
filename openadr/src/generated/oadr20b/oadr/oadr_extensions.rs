...
impl crate::xsd_util::WriteXml for OadrExtensions {
    fn write<W>(
        &self,
...
impl OadrExtensions {
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "oadrExtensions")?;
        OadrExtensions::read(reader, &attr, "oadrExtensions")
    }
}

impl crate::xsd_util::ReadXml for OadrExtensions {
