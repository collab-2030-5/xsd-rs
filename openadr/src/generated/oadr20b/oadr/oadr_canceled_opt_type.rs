...
impl OadrCanceledOptType {
        ...
        W: std::io::Write,
    {
        ...
        if let Some(elem) = &self.ei_opt_id {
            crate::xsd_util::write_simple_element(writer, "ei:optID", elem.as_str())?;
        }
        Ok(())
    }
...
impl crate::xsd_util::WriteXml for OadrCanceledOptType {
    fn write<W>(
        &self,
...
impl OadrCanceledOptType {
        ...
        R: std::io::Read,
    {
        ...
        Ok(OadrCanceledOptType {
            ei_ei_response: ei_ei_response.require()?,
            ei_opt_id: ei_opt_id.get(),
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "oadrCanceledOpt")?;
        OadrCanceledOptType::read(reader, &attr, "oadrCanceledOpt")
    }
}

impl crate::xsd_util::ReadXml for OadrCanceledOptType {
        ...
        R: std::io::Read,
    {
        ...
        match OadrCanceledOptType::read_top_level(&mut reader) {
            Ok(x) => Ok(x),
            Err(err) => {
