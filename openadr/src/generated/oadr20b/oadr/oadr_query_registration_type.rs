...
impl OadrQueryRegistrationType {
    fn write_elem<W>(
        &self,
...
impl crate::xsd_util::WriteXml for OadrQueryRegistrationType {
    fn write<W>(
        &self,
...
impl OadrQueryRegistrationType {
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "oadrQueryRegistration")?;
        OadrQueryRegistrationType::read(reader, &attr, "oadrQueryRegistration")
    }
}

impl crate::xsd_util::ReadXml for OadrQueryRegistrationType {
        ...
        R: std::io::Read,
    {
        ...
        match OadrQueryRegistrationType::read_top_level(&mut reader) {
            Ok(x) => Ok(x),
            Err(err) => {
