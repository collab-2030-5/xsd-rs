...
impl FrequencyType {
        ...
        W: std::io::Write,
    {
        ...
        let start = if write_type {
            start.attr("xsi:type", "FrequencyType")
        } else {
            start
        };
        writer.write(start)?;
...
impl crate::xsd_util::WriteXml for FrequencyType {
    fn write<W>(
        &self,
        ...
        W: std::io::Write,
    {
        ...
        self.write_with_name(&mut writer, "oadr:frequency", true, false)?;
        Ok(())
    }
}
...
impl FrequencyType {
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "frequency")?;
        FrequencyType::read(reader, &attr, "frequency")
    }
}

impl crate::xsd_util::ReadXml for FrequencyType {
