...
impl OadrEvent {
        ...
        R: std::io::Read,
    {
        ...
        let mut ei_ei_event: crate::xsd_util::SetOnce<crate::oadr20b::ei::EiEventType> =
            Default::default();
        let mut oadr_oadr_response_required: crate::xsd_util::SetOnce<
        ...
        loop {
            match reader.next()? {
                ...
                xml::reader::XmlEvent::StartElement {
                    ...
                    "oadrResponseRequired" => oadr_oadr_response_required.set(
