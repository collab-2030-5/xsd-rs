...
impl crate::xsd_util::WriteXml for OadrRegisteredReportType {
    fn write<W>(
        &self,
...
impl OadrRegisteredReportType {
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "oadrRegisteredReport")?;
        OadrRegisteredReportType::read(reader, &attr, "oadrRegisteredReport")
    }
}

impl crate::xsd_util::ReadXml for OadrRegisteredReportType {
