...
pub struct OadrCreateReportType {
    ...
    /// Request report
    pub oadr_oadr_report_request: Vec<crate::oadr20b::oadr::OadrReportRequestType>,
    pub ei_ven_id: Option<String>,
    pub ei_schema_version: Option<crate::oadr20b::ei::SchemaVersionType>,
}

impl OadrCreateReportType {
    fn write_elem<W>(
        &self,
...
impl crate::xsd_util::WriteXml for OadrCreateReportType {
    fn write<W>(
        &self,
        ...
        W: std::io::Write,
    {
        ...
        self.write_with_name(&mut writer, "oadr:oadrCreateReport", true, false)?;
        Ok(())
    }
}
...
impl OadrCreateReportType {
        ...
        R: std::io::Read,
    {
        ...
        let mut oadr_oadr_report_request: Vec<crate::oadr20b::oadr::OadrReportRequestType> =
            Default::default();
        ...
        loop {
            match reader.next()? {
                ...
                xml::reader::XmlEvent::StartElement {
                    ...
                    "oadrReportRequest" => oadr_oadr_report_request.push(
                        crate::oadr20b::oadr::OadrReportRequestType::read(
                            reader,
                            &attributes,
                            "oadrReportRequest",
                        )?,
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "oadrCreateReport")?;
        OadrCreateReportType::read(reader, &attr, "oadrCreateReport")
    }
}

impl crate::xsd_util::ReadXml for OadrCreateReportType {
        ...
        R: std::io::Read,
    {
        ...
        match OadrCreateReportType::read_top_level(&mut reader) {
            Ok(x) => Ok(x),
            Err(err) => {
