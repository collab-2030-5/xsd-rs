...
impl crate::xsd_util::WriteXml for OadrCreatedEventType {
    fn write<W>(
        &self,
...
impl OadrCreatedEventType {
        ...
        R: std::io::Read,
    {
        ...
        let mut pyld_ei_created_event: crate::xsd_util::SetOnce<
            crate::oadr20b::pyld::EiCreatedEvent,
        > = Default::default();
...
impl crate::xsd_util::ReadXml for OadrCreatedEventType {
        ...
        R: std::io::Read,
    {
        ...
        match OadrCreatedEventType::read_top_level(&mut reader) {
            Ok(x) => Ok(x),
            Err(err) => {
