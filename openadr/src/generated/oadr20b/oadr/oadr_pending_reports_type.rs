...
impl crate::xsd_util::WriteXml for OadrPendingReportsType {
    fn write<W>(
        &self,
...
impl OadrPendingReportsType {
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "oadrPendingReports")?;
        OadrPendingReportsType::read(reader, &attr, "oadrPendingReports")
    }
}

impl crate::xsd_util::ReadXml for OadrPendingReportsType {
        ...
        R: std::io::Read,
    {
        ...
        match OadrPendingReportsType::read_top_level(&mut reader) {
            Ok(x) => Ok(x),
            Err(err) => {
