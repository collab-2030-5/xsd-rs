...
impl crate::xsd_util::WriteXml for CurrencyType {
    fn write<W>(
        &self,
...
impl CurrencyType {
        ...
        R: std::io::Read,
    {
        ...
        let mut item_description: crate::xsd_util::SetOnce<
            crate::oadr20b::oadr::CurrencyItemDescriptionType,
        > = Default::default();
        let mut item_units: crate::xsd_util::SetOnce<
            ...
            match reader.next()? {
                ...
                xml::reader::XmlEvent::StartElement { name, .. } => {
                    match name.local_name.as_str() {
                        "itemDescription" => item_description.set(
                            crate::xsd_util::read_string_enum(reader, "itemDescription")?,
                        )?,
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "currency")?;
        CurrencyType::read(reader, &attr, "currency")
    }
}

impl crate::xsd_util::ReadXml for CurrencyType {
