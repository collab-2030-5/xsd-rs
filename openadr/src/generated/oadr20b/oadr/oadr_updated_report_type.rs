...
impl crate::xsd_util::WriteXml for OadrUpdatedReportType {
    fn write<W>(
        &self,
        ...
        W: std::io::Write,
    {
        ...
        self.write_with_name(&mut writer, "oadr:oadrUpdatedReport", true, false)?;
        Ok(())
    }
}
...
impl OadrUpdatedReportType {
        ...
        R: std::io::Read,
    {
        ...
        let mut ei_ei_response: crate::xsd_util::SetOnce<crate::oadr20b::ei::EiResponseType> =
            Default::default();
        let mut oadr_oadr_cancel_report: crate::xsd_util::SetOnce<
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "oadrUpdatedReport")?;
        OadrUpdatedReportType::read(reader, &attr, "oadrUpdatedReport")
    }
}

impl crate::xsd_util::ReadXml for OadrUpdatedReportType {
