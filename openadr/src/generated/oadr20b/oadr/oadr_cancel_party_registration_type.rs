...
impl crate::xsd_util::WriteXml for OadrCancelPartyRegistrationType {
    fn write<W>(
        &self,
        ...
        W: std::io::Write,
    {
        ...
        self.write_with_name(&mut writer, "oadr:oadrCancelPartyRegistration", true, false)?;
        Ok(())
    }
}
...
impl OadrCancelPartyRegistrationType {
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "oadrCancelPartyRegistration")?;
        OadrCancelPartyRegistrationType::read(reader, &attr, "oadrCancelPartyRegistration")
    }
}

impl crate::xsd_util::ReadXml for OadrCancelPartyRegistrationType {
