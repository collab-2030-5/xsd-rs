...
impl crate::xsd_util::WriteXml for OadrPayload {
    fn write<W>(
        &self,
...
impl OadrPayload {
        ...
        R: std::io::Read,
    {
        ...
        let mut oadr_oadr_signed_object: crate::xsd_util::SetOnce<
            crate::oadr20b::oadr::OadrSignedObject,
        > = Default::default();
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "oadrPayload")?;
        OadrPayload::read(reader, &attr, "oadrPayload")
    }
}

impl crate::xsd_util::ReadXml for OadrPayload {
