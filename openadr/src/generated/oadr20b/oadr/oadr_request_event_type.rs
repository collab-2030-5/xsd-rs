...
impl crate::xsd_util::WriteXml for OadrRequestEventType {
    fn write<W>(
        &self,
        ...
        loop {
            match reader.next()? {
                ...
                xml::reader::XmlEvent::StartElement {
                    ...
                    "eiRequestEvent" => {
                        pyld_ei_request_event.set(crate::oadr20b::pyld::EiRequestEvent::read(
                            reader,
                            &attributes,
                            "eiRequestEvent",
                        )?)?
...
impl crate::xsd_util::ReadXml for OadrRequestEventType {
