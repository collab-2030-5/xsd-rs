...
impl crate::xsd_util::WriteXml for OadrTransport {
    fn write<W>(
        &self,
...
impl OadrTransport {
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "oadrTransport")?;
        OadrTransport::read(reader, &attr, "oadrTransport")
    }
}

impl crate::xsd_util::ReadXml for OadrTransport {
