...
impl OadrCanceledReportType {
        ...
        W: std::io::Write,
    {
        ...
        let start = if write_type {
            start.attr("xsi:type", "oadrCanceledReportType")
        } else {
            start
        };
        writer.write(start)?;
...
impl crate::xsd_util::WriteXml for OadrCanceledReportType {
    fn write<W>(
        &self,
...
impl OadrCanceledReportType {
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "oadrCanceledReport")?;
        OadrCanceledReportType::read(reader, &attr, "oadrCanceledReport")
    }
}

impl crate::xsd_util::ReadXml for OadrCanceledReportType {
        ...
        R: std::io::Read,
    {
        ...
        match OadrCanceledReportType::read_top_level(&mut reader) {
            Ok(x) => Ok(x),
            Err(err) => {
