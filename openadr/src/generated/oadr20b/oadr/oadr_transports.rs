...
pub struct OadrTransports {
    pub oadr_transport: Vec<crate::oadr20b::oadr::OadrTransport>,
}
...
impl crate::xsd_util::WriteXml for OadrTransports {
    fn write<W>(
        &self,
...
impl OadrTransports {
        ...
        R: std::io::Read,
    {
        ...
        loop {
            match reader.next()? {
                ...
                xml::reader::XmlEvent::StartElement {
                    ...
                    "oadrTransport" => {
                        oadr_transport.push(crate::oadr20b::oadr::OadrTransport::read(
                            reader,
                            &attributes,
                            "oadrTransport",
                        )?)
        ...
        Ok(OadrTransports { oadr_transport })
    }
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "oadrTransports")?;
        OadrTransports::read(reader, &attr, "oadrTransports")
    }
}

impl crate::xsd_util::ReadXml for OadrTransports {
