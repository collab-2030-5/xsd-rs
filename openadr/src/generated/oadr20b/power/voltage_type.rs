...
impl VoltageType {
        ...
        W: std::io::Write,
    {
        ...
        let start = if write_type {
            start.attr("xsi:type", "VoltageType")
        } else {
            start
        };
        writer.write(start)?;
...
impl crate::xsd_util::WriteXml for VoltageType {
    fn write<W>(
        &self,
...
impl VoltageType {
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "voltage")?;
        VoltageType::read(reader, &attr, "voltage")
    }
}

impl crate::xsd_util::ReadXml for VoltageType {
