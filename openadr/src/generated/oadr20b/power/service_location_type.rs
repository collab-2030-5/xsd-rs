...
impl crate::xsd_util::WriteXml for ServiceLocationType {
    fn write<W>(
        &self,
...
impl ServiceLocationType {
        ...
        R: std::io::Read,
    {
        ...
        let mut gml_feature_collection: crate::xsd_util::SetOnce<
            crate::oadr20b::gml::FeatureCollection,
        > = Default::default();
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "serviceLocation")?;
        ServiceLocationType::read(reader, &attr, "serviceLocation")
    }
}

impl crate::xsd_util::ReadXml for ServiceLocationType {
