...
impl EnergyRealType {
        ...
        W: std::io::Write,
    {
        ...
        let start = if write_type {
            start.attr("xsi:type", "EnergyRealType")
        } else {
            start
        };
        writer.write(start)?;
...
impl crate::xsd_util::WriteXml for EnergyRealType {
    fn write<W>(
        &self,
...
impl EnergyRealType {
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "energyReal")?;
        EnergyRealType::read(reader, &attr, "energyReal")
    }
}

impl crate::xsd_util::ReadXml for EnergyRealType {
