...
impl crate::xsd_util::WriteXml for PowerReactiveType {
    fn write<W>(
        &self,
...
impl PowerReactiveType {
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "powerReactive")?;
        PowerReactiveType::read(reader, &attr, "powerReactive")
    }
}

impl crate::xsd_util::ReadXml for PowerReactiveType {
