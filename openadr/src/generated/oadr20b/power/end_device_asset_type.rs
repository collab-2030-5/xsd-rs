...
impl EndDeviceAssetType {
        ...
        W: std::io::Write,
    {
        ...
        let start = if write_type {
            start.attr("xsi:type", "EndDeviceAssetType")
        } else {
            start
        };
        writer.write(start)?;
...
impl crate::xsd_util::WriteXml for EndDeviceAssetType {
    fn write<W>(
        &self,
        ...
        W: std::io::Write,
    {
        ...
        self.write_with_name(&mut writer, "power:endDeviceAsset", true, false)?;
        Ok(())
    }
}
...
impl EndDeviceAssetType {
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "endDeviceAsset")?;
        EndDeviceAssetType::read(reader, &attr, "endDeviceAsset")
    }
}

impl crate::xsd_util::ReadXml for EndDeviceAssetType {
