...
impl EnergyApparentType {
        ...
        W: std::io::Write,
    {
        ...
        let start = if write_type {
            start.attr("xsi:type", "EnergyApparentType")
        } else {
            start
        };
        writer.write(start)?;
...
impl crate::xsd_util::WriteXml for EnergyApparentType {
    fn write<W>(
        &self,
...
impl EnergyApparentType {
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "energyApparent")?;
        EnergyApparentType::read(reader, &attr, "energyApparent")
    }
}

impl crate::xsd_util::ReadXml for EnergyApparentType {
