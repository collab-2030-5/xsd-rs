...
impl EnergyReactiveType {
        ...
        W: std::io::Write,
    {
        ...
        let start = if write_type {
            start.attr("xsi:type", "EnergyReactiveType")
        } else {
            start
        };
        writer.write(start)?;
...
impl crate::xsd_util::WriteXml for EnergyReactiveType {
    fn write<W>(
        &self,
...
impl EnergyReactiveType {
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "energyReactive")?;
        EnergyReactiveType::read(reader, &attr, "energyReactive")
    }
}

impl crate::xsd_util::ReadXml for EnergyReactiveType {
