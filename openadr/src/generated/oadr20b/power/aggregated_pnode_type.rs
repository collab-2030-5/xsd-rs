...
impl crate::xsd_util::WriteXml for AggregatedPnodeType {
    fn write<W>(
        &self,
...
impl AggregatedPnodeType {
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "aggregatedPnode")?;
        AggregatedPnodeType::read(reader, &attr, "aggregatedPnode")
    }
}

impl crate::xsd_util::ReadXml for AggregatedPnodeType {
