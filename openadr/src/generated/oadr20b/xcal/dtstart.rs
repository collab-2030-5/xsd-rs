...
impl crate::xsd_util::WriteXml for Dtstart {
    fn write<W>(
        &self,
        ...
        W: std::io::Write,
    {
        ...
        self.write_with_name(&mut writer, "xcal:dtstart", true, false)?;
        Ok(())
    }
}
...
impl Dtstart {
        ...
        R: std::io::Read,
    {
        ...
        let mut xcal_date_time: crate::xsd_util::SetOnce<String> = Default::default();
            ...
            match reader.next()? {
                ...
                xml::reader::XmlEvent::StartElement { name, .. } => {
                    match name.local_name.as_str() {
                        "date-time" => xcal_date_time
                            .set(crate::xsd_util::read_string(reader, "date-time")?)?,
                        name => {
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "dtstart")?;
        Dtstart::read(reader, &attr, "dtstart")
    }
}

impl crate::xsd_util::ReadXml for Dtstart {
        ...
        R: std::io::Read,
    {
        ...
        match Dtstart::read_top_level(&mut reader) {
            Ok(x) => Ok(x),
            Err(err) => {
