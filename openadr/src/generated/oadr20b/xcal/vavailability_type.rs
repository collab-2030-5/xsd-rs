...
impl crate::xsd_util::WriteXml for VavailabilityType {
    fn write<W>(
        &self,
...
impl VavailabilityType {
        ...
        R: std::io::Read,
    {
        ...
        let mut components: crate::xsd_util::SetOnce<
        ...
        Ok(VavailabilityType {
            components: components.require()?,
        })
    }
    ...
    where
        R: std::io::Read,
    {
        let attr = crate::xsd_util::read_start_tag(reader, "vavailability")?;
        VavailabilityType::read(reader, &attr, "vavailability")
    }
}

impl crate::xsd_util::ReadXml for VavailabilityType {
        ...
        R: std::io::Read,
    {
        ...
        match VavailabilityType::read_top_level(&mut reader) {
            Ok(x) => Ok(x),
            Err(err) => {
