...
impl xsd_api::WriteXml for DurationPropType {
    fn write<W>(
        &self,
...
impl DurationPropType {
        ...
        R: std::io::Read,
    {
        ...
        let mut duration: xsd_util::SetOnce<String> = Default::default();
            ...
            match reader.next()? {
                ...
                xml::reader::XmlEvent::StartElement { name, .. } => {
                    match name.local_name.as_str() {
                        "duration" => duration.set(xsd_util::read_string(reader, "duration")?)?,
...
impl xsd_api::ReadXml for DurationPropType {
