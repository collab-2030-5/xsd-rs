...
impl xsd_api::WriteXml for RegistrationId {
    fn write<W>(
        &self,
        ...
        W: std::io::Write,
    {
        ...
        self.write_with_name(&mut writer, "ei:registrationID", true, false)?;
        Ok(())
    }
}
...
impl xsd_api::ReadXml for RegistrationId {
        ...
        R: std::io::Read,
    {
        ...
        match RegistrationId::read_top_level(&mut reader) {
            Ok(x) => Ok(x),
            Err(err) => {
